...
<footer id="colophon" class="site-footer clearfix">
	...
	<div class="site-info">
		...
		<?php else : ?>
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme by', 'minimalistique') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'minimalistique'); ?>"><?php echo __(' SuperbThemes', 'minimalistique') ?></a>
			</span>
	...
	<?php if (CustomizerControls::GetSelectedOrDefault(CustomizerControls::FOOTER_GOTOTOP_HIDE) != "1") : ?>
		<a id="goTop" class="to-top" href="#" title="<?php esc_attr_e('To Top', 'minimalistique'); ?>">
